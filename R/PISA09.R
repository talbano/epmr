...
#'  \item r414q02 through r458q04: factor, unscored responses for 11 items
#'  \item r414q02s through r458q04s: numeric, scored responses for 11 items
#'}
#'
#' @format A data frame with 44878 rows and 67 variables
